...
项目地址：https://github.com/xupengxunil/golang_common
...
```
go get -v github.com/xupengxunil/golang_common
```
2. 将配置文件拷贝到你的项目中，配置文件请参考：https://github.com/xupengxunil/golang_common/tree/master/conf/dev
